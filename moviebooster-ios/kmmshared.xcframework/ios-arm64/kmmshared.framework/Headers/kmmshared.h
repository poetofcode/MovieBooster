...
@class KmmsharedPostCompanion, KmmsharedPost, KmmsharedPostRepository, KmmsharedKotlinThrowable, KmmsharedKotlinArray<T>, KmmsharedKotlinException, KmmsharedKotlinRuntimeException, KmmsharedKotlinIllegalStateException;
...
@interface KmmsharedPlatform : KmmsharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
@interface KmmsharedPost : KmmsharedBase
- (instancetype)initWithTitle:(NSString *)title text:(NSString *)text imageUrl:(NSString *)imageUrl __attribute__((swift_name("init(title:text:imageUrl:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) KmmsharedPostCompanion *companion __attribute__((swift_name("companion")));
...
- (KmmsharedPost *)doCopyTitle:(NSString *)title text:(NSString *)text imageUrl:(NSString *)imageUrl __attribute__((swift_name("doCopy(title:text:imageUrl:)")));
...
@interface KmmsharedPostCompanion : KmmsharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) KmmsharedPostCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) KmmsharedPost *DEFAULT __attribute__((swift_name("DEFAULT")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostRepository")))
@interface KmmsharedPostRepository : KmmsharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
